...
module.exports = class PgPersistence {
  ...
  async toggleImportanceTodo(todoListId, todoId) {
    const TOGGLE_IMPORTANT = "UPDATE todos SET important = NOT important" +
                              "  WHERE todolist_id = $1" +
                              "    AND id = $2" +
                              "    AND username = $3";
    let result = await dbQuery(TOGGLE_IMPORTANT, todoListId, todoId, this.username);
    return result.rowCount > 0;
  }
